...
<body class="font-sans bg-[#F7FBFF] text-gray-800">
    ...
    <div class="w-full flex justify-center bg-transparent pt-6">
        <nav x-data="{ open: false }"
            ...
            <!-- Hamburger (mobile) -->
            <button @click="open = !open" class="md:hidden text-white focus:outline-none transition-all duration-300">
                <!-- Icon hamburger -->
            ...
            <div x-show="open" x-transition class="absolute top-20 left-0 w-full flex justify-center md:hidden"
                ...
                <ul
                    class="bg-[#45C3FF] rounded-2xl shadow-lg w-[90%] py-6 flex flex-col items-center gap-4 font-semibold text-white">
