...
<div class="bg-[#45C3FF] min-h-screen w-full py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-10">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-14 md:mb-16 fade-in">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-7 md:p-8 hover-float transition">
      ...
      <button class="w-full py-2.5 sm:py-3 bg-[#54B9FF] hover:bg-[#3fa4ea] text-white font-semibold sm:font-bold rounded-xl transition text-sm sm:text-base">
        Mulai Gratis
      </button>
    </div>

    <!-- Premium Bulanan -->
    <div class="relative bg-white border-2 border-rose-400 rounded-2xl shadow-xl p-6 sm:p-7 md:p-8 hover-float transition">
      <div class="absolute top-3 sm:top-4 right-[-22px] sm:right-[-30px] rotate-45 bg-rose-500 text-white py-1 px-6 sm:px-8 text-[10px] sm:text-xs font-bold shadow">
        POPULER
      </div>
  ...
  <div class="bg-white rounded-2xl shadow-xl p-5 sm:p-6 md:p-8 mb-14 md:mb-16 overflow-x-auto fade-in">
    ...
    <table class="w-full text-sm sm:text-base border-collapse whitespace-nowrap">
      ...
      <tbody>
        <tr class="border-b"><td class="p-3 sm:p-4">Akses Fitur Dasar</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr class="border-b"><td class="p-3 sm:p-4">Game Aritmetika & Logika</td><td>✓</td><td>✓</td><td>✓</td></tr>
        <tr class="border-b"><td class="p-3 sm:p-4">Iklan</td><td>Ada</td><td>✗</td><td>✗</td></tr>
        <tr class="border-b"><td class="p-3 sm:p-4">Game Memori</td><td>✗</td><td>✓</td><td>✓</td></tr>
        <tr class="border-b"><td class="p-3 sm:p-4">Power-ups & Avatar</td><td>✗</td><td>✓</td><td>✓</td></tr>
        <tr class="border-b"><td class="p-3 sm:p-4">Sertifikat Pembelajaran</td><td>✗</td><td>✓</td><td>✓</td></tr>
        <tr class="border-b"><td class="p-3 sm:p-4">Konten Eksklusif</td><td>✗</td><td>✗</td><td>✓</td></tr>
        <tr class="border-b"><td class="p-3 sm:p-4">Akses Early Bird</td><td>✗</td><td>✗</td><td>✓</td></tr>
        <tr class="border-b"><td class="p-3 sm:p-4">Bonus Power-ups Bulanan</td><td>✗</td><td>✗</td><td>✓</td></tr>
        <tr><td class="p-3 sm:p-4">Hemat</td><td>-</td><td>-</td><td>Rp60.000/tahun</td></tr>
      </tbody>
    </table>
  </div>
