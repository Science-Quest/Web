    ...
    <div class="w-full flex justify-center bg-transparent pt-6">
        <nav x-data="{ open: false }"
            ...
            <a href="{{ url('/') }}" class="flex items-center gap-2">
                ...
                <!-- Menu Desktop (tengah) -->
                <ul class="hidden list-none md:flex flex-1 justify-center items-center gap-12 font-semibold">
                ...
                <!-- Dropdown mobile -->
                <div x-show="open" x-transition class="absolute top-20 left-0 w-full flex justify-center md:hidden"
                    @click.away="open = false">

                    <ul
                        class="bg-[#45C3FF] list-none rounded-2xl shadow-lg w-[90%] py-6 flex flex-col items-center gap-4 font-semibold text-white">
    ...
    <div class="w-full md:w-1/2 text-center md:text-left">
      ...
      <p class="mt-4 text-gray-600 leading-relaxed">
        ...
        <section id="categories"
            class="px-6 md:px-16 py-16 bg-gradient-to-tr from-[#ebf7fc] via-[#E9F6FE] to-[#53C2F0]">
                ...
                <div
                    ...
                    <div id="card-description-logika" class="p-4 text-center flex flex-col justify-between h-68">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Latih logikamu dengan games yang akan menguras otak
                            </p>
                        </div>
                        <div>
                ...
                <div class="faq-item flex flex-col gap-y-6  rounded-lg w-full">
                    ...
                    <div class="flex justify-center mt-5" x-data="{ open: false }" @click="open = !open">
                        <div class="w-11/12">
                            ...
                            <!-- Header About -->
                            <section class="bg-[#20B4FF] text-white p-4 rounded-xl flex justify-between items-center">
                                <h3 class="text-xl font-nomal ml-3">Seberapa lama kita harus menyelesaikan setiap
                                    level?</h3>
                                <button class="mr-3">
                                    <!-- Panah atas/bawah -->
                                    <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <section x-show="open" x-transition x-cloak
                                class="bg-[#78d2fc] text-white font-semibold p-6 rounded-b-xl  mx-5 transition ease-in-out">
                                Ada beberapa level yang dibatasi waktu dan ada yang tidak. Setiap level bervariasi untuk
                                batas waktunya.
                            </section>
                    ...
                    <div class="flex justify-center mt-5" x-data="{ open: false }" @click="open = !open">
                        <div class="w-11/12">
                            ...
                            <!-- Header About -->
                            <section class="bg-[#20B4FF] text-white p-4 rounded-xl flex justify-between items-center">
                                <h3 class="text-xl font-normal ml-3">Bagaimana caranya mengundang teman untuk ikut
                                    bergabung?</h3>
                                <button class="mr-3">
                                    <!-- Panah atas/bawah -->
                                    <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <section x-show="open" x-transition x-cloak
                                class="bg-[#78d2fc] text-white font-semibold p-6 rounded-b-xl mx-5 transition ease-in-out">
                                Saat ini Science Quest masih dalam pengembangan aplikasi utama. Untuk sekarang, kamu
                                bisa undang teman -
        ...
        <footer class="bg-[#20B4FF] text-white py-10">
            <div
                class="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8 items-start text-center md:text-left">
                ...
                <div class="flex justify-center md:justify-start space-x-6">
                    <a href="https://www.instagram.com/sciencequest.id/" target="_blank"
                        class="bg-white text-[#45C3FF] w-12 h-12 flex items-center justify-center rounded-full hover:opacity-80 transition">
